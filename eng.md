...
If your `<video>` element doesn't have the controls attribute defined, there's
no way for the user to control the video once they are fullscreen. The
...
![Figure 3][FirefoxOS prompting for access to fullscreen]
...
> If you know of any good patterns for full-screen, leave a comment and we can 
let the world know. If you know of anti-patterns in full-screen let us know so 
we can update the article to save the frustrations of millions of users on the 
web. 
